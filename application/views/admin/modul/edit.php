	...
	<div class="mws-panel-body no-padding">
		...
		<div class="mws-form-row">
			...
			<div class="mws-form-item">
				...
				<input type="text" name="judul_modul" value="<?php echo $modul->judul_modul ?>"size="20" /><br />
			</div>
		</div>
		<div class="mws-form-row">
			...
			<div class="mws-form-item">
				...
				<input type="text" name="key_modul" value="<?php echo $modul->key_modul ?>"size="20" /><br />
			</div>
		</div>
		<div class="mws-form-row">
			<label class="mws-form-label">Kategori</label>
			<div class="mws-form-item">
				<?php echo form_dropdown('id_kategori_sub', $kategori_subs, $modul->id_kategori_sub, 'class="small"'); ?><br />
			</div>
		</div>
		<div class="mws-form-row">
			<label class="mws-form-label">Sort order</label>
			<div class="mws-form-item">
				<input type="text" name="sort_order" value="<?php echo $modul->sort_order ?>"size="20" /><br />
			</div>
		</div>
		<div class="mws-form-row">
			<label class="mws-form-label">Sort order</label>
