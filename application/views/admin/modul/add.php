...
<?php echo form_open_multipart('admin/moduls/create', $attributs) ?>
...
<div class="mws-panel grid_8">
	<div class="mws-panel-body no-padding">
		...
		<div class="mws-form-row">
			...
			<div class="mws-form-item">
				<?php echo form_dropdown('id_kategori_sub', $kategori_subs, set_value('id_kategori_sub'), 'class="small"'); ?><br />
			</div>
		</div>
		<div class="mws-form-row">
		...
		<div class="mws-form-row">
			...
			<div class="mws-form-item">
				...
				<?php echo form_dropdown('status', $options, set_value('status'));?><br />
			</div>
		</div>
