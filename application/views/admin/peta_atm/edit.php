...
<?php echo form_open('admin/peta_atm/update', $attributs) ?>
  ...
  <div class="mws-panel-body no-padding">
    ...
    <div class="mws-form-row">
      ...
      <div class="mws-form-item">
        <?php echo form_input('lat', $row->lat, 'class="small" id="x"'); ?>
      </div>
    </div>
    ...
    <div class="mws-form-row">
      ...
      <div class="mws-form-item">
        <?php echo form_input('long', $row->long, 'class="small" id="y"'); ?>
      </div>
    </div>
    ...
    <div class="mws-form-row">
      ...
      <div class="mws-form-item">
        ...
        <?php echo form_dropdown('jenis', $jenis, $row->jenis_atm , 'class="small"'); ?><br />
      </div>
    </div>
    ...
    <div class="mws-form-row">
      ...
      <div class="mws-form-item">
        <?php echo form_input('lokasi', $row->nama_lokasi, 'class="small"'); ?>
      </div>
    </div>
    ...
    <div class="mws-form-row">
      ...
      <div class="mws-form-item">
        <?php echo form_input('alamat', $row->alamat_lokasi, 'class="small"'); ?>
      </div>
    </div>
    ...
    <div class="mws-form-row">
      ...
      <div class="mws-form-item">
        <?php echo form_textarea('keterangan', $row->keterangan, 'class="small"'); ?>
      </div>
    </div>

    <?php echo form_hidden('id_peta_atm', $row->id_peta_atm); ?>
  </div>
</div>
