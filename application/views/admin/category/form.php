...
<div class="mws-panel grid_8">
  <div class="mws-panel-body no-padding">
    ...
    <div class="mws-form-row">
      <label class="mws-form-label">Nama kategori</label>
      <div class="mws-form-item">
        <span class="error"><?php echo form_error('nama_kategori_en'); ?></span>
        <?php echo form_input('nama_kategori_en', set_value('nama_kategori_en'), 'class="small"'); ?><br />
      </div>
    </div>
  </div>
</div>
...
<div class="mws-panel grid_8">
  <div class="mws-button-row">
    ...
    <?php echo form_hidden('id_kategori_language_en', $rows[1]->id_kategori_language); ?>
