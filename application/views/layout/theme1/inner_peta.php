...
<script type="text/javascript" src="<?php echo base_url()?>assets/theme1/js/mapmarker.jquery.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/theme1/js/mapmarker_func.jquery.js"></script>
