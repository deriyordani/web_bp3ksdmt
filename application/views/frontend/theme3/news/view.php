...
<div class="box-berita" style="margin-top:0">
    ...
    <h2 class="head-title"><?php echo $get_news_view->judul_news; ?></h2>
...
<h2 class="head-title"><?php echo $text_comment; ?></h2>
<ul class="komentar">
...
<div id="comment">
    <form method="post">
        ...
        <div class="box-300 floated-left">
            <label><?php echo $text_name; ?>:</label><br/>
            ...
            <label><?php echo $text_url; ?>:</label><br/>
