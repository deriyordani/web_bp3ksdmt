<div id="simulasi_produk" class="content">
	...
	<form id="simulasikreditflat" name="simulasikreditflat" method="post">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableform" style="width:70%">
			<tbody>
				<tr>
					<td>Type of Calculation<br><br></td>
					<td><select style="border:1px solid #ccc;" name="kategori" id="formcategory" class="valid">
				...
				<tr>
					<td>Ceiling (Rp.)<br><br></td>
					<td><input style="border:1px solid #ccc;" type="text" name="plafond" id="formplafond" class="w100 valid" value="<?php if(isset($_POST['calculate'])) echo $_POST['plafond']; ?>"></td>
					
				</tr>
				<tr>
					<td>Period (month)<br><br></td>
					<td width="25%"><input style="border:1px solid #ccc;" name="jangkabulan" type="text" id="formjangkawaktu" class="w100" value="<?php if(isset($_POST['calculate'])) echo $_POST['jangkabulan']; ?>"><br><br></td>
					
				</tr>
				<tr>
					<td>Interest (%/month)<br><br></td>
					<td><input style="border:1px solid #ccc;" name="bungabulan" type="text" id="formbungabulan" class="w100" value="<?php if(isset($_POST['calculate'])) echo $_POST['bungabulan']; else echo $bunga_db; ?>"><br><br></td>
					
				</tr>
				<tr>
					<td>&nbsp;<br><br></td>
					<td><input type="submit" name="calculate" id="calculate" value="Calculate" class="btn"><br><br></td>
				</tr>
			</tbody>
		</table>
	</form>
	...
	?>
	<br><br><br>
	<table width="100%" border="1" cellspacing="0" cellpadding="0" class="tableresult tab-kurs">
		<thead>
	  	<tr>
	  	...
	  	<?php
	  		...
	  		for($i=1;$i<=$jangkabulan;$i++){
	  			...
	  			if($i%12 == 0){
	  				...
	  				echo "<tr bgcolor='#ccc' style='font-size:17px;'>
		  			<td></td>
		  			<td><strong style='font-weight:bold;'>".number_format($pokok_sum)."</strong></td>
		  			<td><strong style='font-weight:bold;'>".number_format($bunga_sum)."</strong></td>
		  			<td><strong style='font-weight:bold;'>".number_format($angsuran_sum)."</strong></td>
		  			<td></td>
		  			</tr>";
	  			}
